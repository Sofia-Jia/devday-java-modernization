...
/**
 * Modernized InventoryService (Java 21)
 *
 * Improvements:
...
public class InventoryService {
    ...
    /**
     * Add product to inventory (modernized)
     */
    public void addProduct(Product product, int quantity) {
        ...
        inventory.put(product.id(), quantity);
    }
    ...
    /**
     * Find low stock products (modernized with .toList())
     */
    ...
    /**
     * Find out of stock products (modernized with .toList())
     */
    ...
    /**
     * Get total inventory value (modernized with record accessors)
     */
    public java.math.BigDecimal getTotalInventoryValue() {
        return inventory.entrySet().stream()
            .map(entry -> {
                ...
                return product.price().multiply(new java.math.BigDecimal(entry.getValue()));
            })
...
/**
 * InventorySummary record (Java 21)
 * Immutable data carrier for inventory statistics
 */
